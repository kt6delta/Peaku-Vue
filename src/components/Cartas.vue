        ...
        <div class="card-text">
          ...
          <div class="d-flex align-items-end pt-3">
            ...
            <p class="me-5">
              ...
              <div v-if="job.salario"> {{ job.salario_3 }} </div> <div v-else>Confidencial</div>
            </p>
            ...
            <p class="me-5">
              ...
              {{ job.vacantes }} 
              <div v-if="job.vacantes > 1">Vacantes</div>
          ...
          <!-- Ver más. -->
          <div class="d-flex">
            <button type="button" class="me-1 btn btn-outline-secondary py-0 px-2 rounded-pill" @click="verMas(indice)">
              Ver más
            </button>
            <div class="mp-4" id="div_vermas" v-if="job.see_description">{{job.description}}</div>
          </div>
